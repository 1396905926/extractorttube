...
import org.schabi.newpipe.extractor.JiaMiEncrypted;
...
public final class YoutubeParsingHelper {
     ...
     */
    private static final String HARDCODED_KEY = JiaMiEncrypted.HARDCODED_KEY;
     ...
     */
    private static final String ANDROID_YOUTUBE_KEY = JiaMiEncrypted.ANDROID_YOUTUBE_KEY;
     ...
     * reverse-engineering app network requests.
     */
    private static final String IOS_YOUTUBE_KEY = JiaMiEncrypted.IOS_YOUTUBE_KEY;
    ...
    private static final String[] HARDCODED_YOUTUBE_MUSIC_KEY =
            {JiaMiEncrypted.HARDCODED_YOUTUBE_MUSIC_KEY, "67", "1.20220808.01.00"};
